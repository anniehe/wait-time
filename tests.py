...
class AddOpenStatusFalseTestCase(TestCase):
    """Unit test for adding open status with a mock False value for is open now."""

    def setUp(self):
        """Do before every test."""

        def _mock_is_open_now_false(keyword, location):
            """Mocks Google Places API call to return False for current open status."""
...
class AddOpenStatusNoneTestCase(TestCase):
    """Unit test for adding open status with a mock None value for is open now."""

    def setUp(self):
        """Do before every test."""

        def _mock_is_open_now_none(keyword, location):
            """Mocks Google Places API call to return None for current open status."""
